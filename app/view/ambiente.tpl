        ...
        <div id="fotos-ambiente">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                  <img  class="d-block w-100" src="{$GET_PUBLIC}image/foto-ambiente-1.jpg" alt="Primeiro Slide">
                </div>
                <div class="carousel-item ">
                  <img  class="d-block w-100" src="{$GET_PUBLIC}image/foto-ambiente-2.jpg" alt="Segundo Slide">
                </div>
                <div class="carousel-item ">
                  <img  class="d-block w-100" src="{$GET_PUBLIC}image/foto-ambiente-4.jpg" alt="Terceiro Slide">
                </div>
                <div class="carousel-item ">
                  <img  class="d-block w-100" src="{$GET_PUBLIC}image/lenha.jpg" alt="Quarto Slide">
                </div>
                <div class="carousel-item ">
                  <img  class="d-block w-100" src="{$GET_PUBLIC}image/lenha2.png" alt="Quinto Slide">
                </div>
                <div class="carousel-item ">
                  <img  class="d-block w-100" src="{$GET_PUBLIC}image/lenha3.jpg" alt="Sexto Slide">
                </div>
            </div>
